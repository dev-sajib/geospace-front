      ...
      <div className=" max-w-container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="h-[92px] flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center space-x-3">
            ...
            <button
              className="text-gray-700 hover:text-emerald-600  transition-colors duration-200 whitespace-nowrap"
              g-16
        ...
        >
          <div className="px-2 pt-2 pb-6 space-y-1 bg-white border-t border-gray-100">
            ...
            <div className="pt-4 space-y-3 border-t border-gray-200">
              ...
              <button
                className="block w-full text-left px-3 py-2 g-15  text-gray-700 hover:text-emerald-600 hover:bg-gray-50 rounded-md transition-colors duration-200"
                onClick={() => navigate("/login")}
              >
                Log In
              </button>
