    ...
    <div className="p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
      <div className="prose prose-sm sm:prose lg:prose-lg max-w-none text-gray-700">
        <div className="mb-6 sm:mb-8">
          <span className="inline-flex bg-emerald-100 text-emerald-800 text-xs sm:text-sm font-medium px-3 sm:px-4 py-1 sm:py-2 rounded-full items-center gap-2">
            <svg
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            operates tools across our Sites that support Freelancers and
            Clients, such as our time-tracking tool. Our tools, sourcing and
            matching service, and other offerings, such as providing
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            highly skilled Freelancers (the "Network"). We call Freelancers in
            the space Geoespacec (for English) or "Geocientists Works
            "Geoespacec" in English or, Geoespacec in French (for the space of
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            business of selling your information. This privacy policy ("Privacy
            Policy") explains our data practices in depth so that you know how
            and why we collect and use your information in compliance with
            applicable data regulations.
          </p>
        </section>
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            vendors, blog readers, and job applicants, and others by applicable
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            professionalism, and technical skills. If we admit you as a Talent,
            we may also collect this information throughout your time in the
            Network. We may ask you to provide information about yourself, which
            could include your:
          </p>
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            training purposes. Geoespacec provides freelancers and our internal
            team members the use of a geoespacec.ca email address. Geoespacec
            stores and processes information sent to and from all geoespacec.ca
            email addresses.
          </p>
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            identification through an application on your mobile phone or
            computer (the "Verification Data"). The Verification Data is
            provided to our biometric technology service provider by Amazon
            recognition systems. Amazon Recognition completes such verifications
            through its approved third-party identification verification
            providers, which uses facial recognition technology to analyze the
            geometry of your face from the photographs to extract biometric
            information or biometric identifiers relating to you (collectively,
            "Biometric Data"), as well as validates the legitimacy of your
            government-issued identification to confirm your identity. Amazon
            Rekognition sends us the Verification Data that indicates whether
            Verify was able to verify your identity from the biometric from your
            government-issued identification for reference and fraud
            investigation purposes under our legitimate interests. Geoespacec
            Security stores a copy of your government-issued identification for
            as long as there is a continued and legitimate need for our
            verification of your identity by direction from Geoespacec.
            Geoespacec also retains the results and related Verification and
            Biographical Data, for as long as your account related to the
            individual being verified is active, for its legitimate purpose of
            verifying the identities of people applying or receiving services;
            to assist in complying with applicable laws and regulations; and/or
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            relevant address, (collectively, "Biographical Data") to verify your
            identity. The Biographical Data is provided to our identity
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            identification have been verified. As noted above, Geoespacec does
            not receive the Biometric Data. In no event does Amazon Rekognition
            or Verify retain Biometric Data for longer than the purpose
            described above, or three years from your last interaction with
            Geoespacec, whichever is earlier unless required by law. Please
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            and Biometric Data, please review the Amazon Rekognition website and
            Privacy Policy.
          </p>
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            written consent to the collection of such additional data by the
            third-party service provider will be solicited at such time, under
            applicable laws.
          </p>
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            freelancers. We may also display some of your information on public
            sections of Geoespacec, marketing materials, and presentations to
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            sources such as professional job boards or social media websites,
            like LinkedIn. We use this information to supplement the information
            that you provide to us or to assess if you may be a good fit for the
            Network. We also collect information about you that you provide to
            our affiliates.
          </p>
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            to requests from public and governmental authorities, enforcing our
            agreements, protecting our operations, protecting our rights,
            privacy, safety or property, and/or that of you or others, and allow
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            time. These recordings allow Geoespacec team members to review
            applications to the Network, to better review your suitability for a
            Client engagement or for internal quality assurance and training
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            use your Data. Please review the terms of any third-party site for
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            engage our Talent. This information may include, among other kinds
            of data:
          </p>
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            reason for which you provided it. If you provide Personal Data to
            obtain access to the Services, we will use your Data through our
            performance of our contract with you to provide you with access to
            such Services, maintain your account, contact you regarding your use
            of the Services and/or the Sites and to notify you of important
            changes to the Services and/or the Sites or to monitor your use of
            such Services.
          </p>
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            marketing communications. You cannot opt out of some administrative
            communications that are reasonably necessary to the Services, such
            as billing or Service notifications, as those are not considered
            marketing communications. In addition, if at any time you wish not
            to receive any future marketing communications or wish for us to
            delete your contact information from our mailing lists, please
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            team members to review your requirements for sourcing or matching
            Talent, specifics about a particular engagement, or for internal
            quality assurance and training purposes. Additionally, your
            interviews with freelancers for specific engagements may be recorded
            for internal purposes and, upon request, provided to you to review
            the call.
          </p>
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            of that process. If you do not provide us with certain information
            that we request, it may impact our ability to assess your
            suitability for a role with us or we may not be able to offer you a
            position with Geoespacec. With your prior consent, we may record
            your audio or video interview(s) to better evaluate your candidacy
            and for training purposes. Your consent is voluntary, and you may
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            including, if applicable to you, special categories of Personal
            Data, which we will solicit your consent to collect at the time. We
            may also collect copies of relevant identification documents from
            you, such as your passport or driving license, proof of address, a
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            providers assisting us in completing our obligations to you, such as
            payroll providers.
          </p>
        </section>
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            technologies. Please review the Geoespacec Cookie Policy or relevant
            cookie policy for one of our other websites to learn more about how
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            from which we understand the country you are connecting at the time
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            Site visitors interact with our Site to improve your use of the
            Site.
          </p>
        </section>
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            create an account by using credentials from a third-party service or
            sign-in services such as your Google account, these services will
            authenticate your identity and provide you with the option to share
            certain Personal Data, such as name and email address(es), with us.
            Use of account-level data is necessary to perform a contract with us
            about your use of the software or it is in our legitimate interest
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            conducting usage statistics to ensure our software is working as
            intended and to make improvements to our Services. We use service
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            directly or through granting access to your Personal Data through
            the event, such as contact details on a business card. We will use
            this information to develop a potential business relationship with
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            you have the right to withdraw your consent at any time by following
            the instructions to "opt-out" of receiving marketing communication
            in each marketing email we send you by contacting us at
            privacy@geoespacec.ca or by mail at the address in the Contacting
            Geoespacec section below.
          </p>
        </section>
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            circumstances in which we may share your Data with certain third
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            services, our hosting and cloud computing service providers,
            providers of customer relationship software, marketing and sales
            software solutions, providers of billing and processing payment
            functions and providers of background check services. When we engage
            another company to perform a function of this nature, we only
            provide them with the information that they need to perform their
            specific function. Under our instructions these parties may access,
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            payment by Stripe's Privacy Policy, Transfers deposit, and PayPal
            Policies
          </p>
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            Geoespacec, (iii) act in urgent circumstances to protect the
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            reporting requirements. If you elect to receive marketing
            communications from us, we retain information about your marketing
            preferences until you opt out of receiving these communications and
            by our policies. To determine the appropriate retention period for
            your Personal Data, we will consider the amount, nature, and
            ...
            for which we use your Data and whether we can achieve those purposes
            through other means, and the applicable legal requirements. In some
            circumstances, we may anonymize your Data so that it can no longer
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            significant legal effect on you, unless such profiling is necessary
            for entering into, or the performance of, a contract between you and
            us, or with your explicit consent. We use automated decision-making
            to ensure that we comply with various laws and regulations
            restricting what regions, individuals, and entities we can work
            with. We also use automated decision-making to ensure applications
            from Freelancers and Job Applicants meet our minimum requirements.
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            Privacy Policy. This Privacy Policy shall not apply to any
            unsolicited information you provide to Geoespacec through this Site
            or any other means (without prejudice to your rights under the
            applicable law). This includes but is not limited to, information
            posted to any public areas of the Sites, such as forums
            ...
            Geoespacec shall be free to reproduce, use, disclose, distribute,
            and exploit such Unsolicited Information without limitation or
            attribution.
          </p>
        </section>
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            the age of 16 provided Personal Data to Geoespacec through this
            Site, please get in touch with us, and we will endeavour to delete
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            not by Geoespacec's Privacy Policy. By providing these links we do
            not imply that we endorse or have reviewed the Third-Party Sites. We
            suggest contacting those sites directly for information on their
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            special care in deciding what information you send to us in this
            way.
          </p>
        </section>
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            prior notice unless otherwise required by the applicable law. Please
            review this policy periodically, especially before you provide any
        ...
        <section className="mb-6 sm:mb-8">
          ...
          <p className="mb-3 sm:mb-4 text-sm sm:text-base">
            ...
            overseeing questions regarding this Privacy Policy. You may contact
            the Geoespacec Privacy Team as follows: by email at
