...
const VideoCard = ({ backgroundImage, title = "Watch Now", onClick }) => {
  return (
    <div
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-[#5cad9ac7] opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center rounded-t-xl"></div>
