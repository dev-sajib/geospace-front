...
const PartnerLogo = ({ name, logo }) => {
  return (
    <div className="partner-card flex flex-col">
      <div className="partner-logo-container bg-white rounded-lg flex items-center justify-center mb-2 sm:mb-3 lg:mb-4 hover:bg-gray-50 transition-colors duration-200 border border-gray-100">
        <img
          src={logo}
          alt={name}
          ...
          <div className="relative">
            ...
            >
              {partnershipSlides.map((slide, slideIndex) => (
                <SwiperSlide
                  key={slideIndex}
                  className="shadow-[2px_5px_50px_rgba(0,0,0,0.05)] mt-[30px] mb-[30px]"
                >
                  <PartnerLogo {...slide} />
                </SwiperSlide>
              ))}
