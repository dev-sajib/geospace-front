    ...
    <section className="pt-[240px] bg-white">
      <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <TabComponent
          tabs={tabsData}
          defaultTabClassName={
            "flex items-center space-x-1 sm:space-x-2 px-3 py-2 sm:px-4 sm:py-2 rounded-lg  sm:text-sm text-[16px] leading-[150%] font-normal transition-all duration-200 whitespace-nowrap flex-shrink-0"
          }
          inactiveTabClassName={"bg-white"}
        >
          {Object.entries(groupedFreelancers).map(
            ([serviceId, freelancersList]) => (
